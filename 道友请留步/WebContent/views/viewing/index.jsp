...
<!-- Bootstrap-CSS -->	  <link rel="stylesheet" href="../../css/viewing/bootstrap.css" type="text/css" media="all">
<!-- Index-Page-CSS -->	  <link rel="stylesheet" href="../../css/viewing/style.css"		  type="text/css" media="all">
<!-- Owl-Carousel-CSS --> <link rel="stylesheet" href="../../css/viewing/owl.carousel.css"  type="text/css" media="all">
<!-- Date-Picker-CSS -->  <link rel="stylesheet" href="../../css/viewing/jquery-ui.css"	  type="text/css" media="all">
<!-- Chocolat-CSS -->	  <link rel="stylesheet" href="../../css/viewing/chocolat.css"	  type="text/css" media="all">
<!-- //Custom-Stylesheet-Links -->
...
<!-- CSS --> <link rel="stylesheet" href="../../css/viewing/font-awesome.css" 	 type="text/css" media="all">
<!-- TTF --> <link rel="stylesheet" href="fonts/fontawesome-webfont.ttf" type="text/css" media="all">
<!-- //Font-Awesome-File-Links -->

<!-- Supportive-JavaScript -->
<script src="../../js/viewing/modernizr.js"></script>
<!-- //Supportive-JavaScript -->
...
<body>
		...
		<div class="slider">
			<ul class="rslides" id="slider">
				<li class="first-slide w3ls">
					<img src="../../img/viewing/slide-1.jpg" alt="Odyssey">
				...
				<li class="second-slide aits">
					<img src="../../img/viewing/slide-2.jpg" alt="Odyssey">
					<div class="wthreexperience">
				...
				<li class="third-slide w3-agileits">
					<img src="../../img/viewing/slide-3.jpg" alt="Odyssey">
					<div class="wthreexperience">
				...
				<li class="fourth-slide agileinfo">
					<img src="../../img/viewing/slide-4.jpg" alt="Odyssey">
					<div class="wthreexperience">
				...
				<li class="fifth-slide wthree">
					<img src="../../img/viewing/slide-5.jpg" alt="Odyssey">
					<div class="wthreexperience">
					...
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							...
							<div class="modal-body">
								<img src="../../img/viewing/about.jpg" alt="Odyssey">
	...
	<div class="wthreelocationsaits" id="wthreelocationsaits">
		<div class="container">
			...
			<section class="grid3d vertical" id="grid3d">
				<div class="grid-wrap">
					<div class="grid">
						<figure class="col-md-4 effect-zoe"><img src="../../img/viewing/location-1.jpg" alt="Odyssey" style="height: 300px;"><figcaption><h4>黄山迎客松</h4></figcaption></figure>
						<figure class="col-md-4 effect-zoe"><img src="../../img/viewing/location-2.jpg" alt="Odyssey" style="height: 300px;"><figcaption><h4>泰山日出</h4></figcaption></figure>
						<figure class="col-md-4 effect-zoe"><img src="../../img/viewing/location-3.jpg" alt="Odyssey" style="height: 300px;"><figcaption><h4>九寨沟</h4></figcaption></figure>
						<figure class="col-md-4 effect-zoe"><img src="../../img/viewing/location-4.jpg" alt="Odyssey" style="height: 300px;"><figcaption><h4>天涯海角</h4></figcaption></figure>
						<figure class="col-md-4 effect-zoe"><img src="../../img/viewing/location-5.jpg" alt="Odyssey" style="height: 300px;"><figcaption><h4>广州塔</h4></figcaption></figure>
						<figure class="col-md-4 effect-zoe"><img src="../../img/viewing/location-6.jpg" alt="Odyssey" style="height: 300px;"><figcaption><h4>洱海</h4></figcaption></figure>
						<figure class="col-md-4 effect-zoe"><img src="../../img/viewing/location-7.jpg" alt="Odyssey" style="height: 300px;"><figcaption><h4>上海迪士尼</h4></figcaption></figure>
						<figure class="col-md-4 effect-zoe"><img src="../../img/viewing/location-8.jpg" alt="Odyssey" style="height: 300px;"><figcaption><h4>灼突泉</h4></figcaption></figure>
						<figure class="col-md-4 effect-zoe"><img src="../../img/viewing/location-9.jpg" alt="Odyssey" style="height: 300px;"><figcaption><h4>成都夜景</h4></figcaption></figure>
					</div>
				</div>
			...
			<div id="owl-demo" class="owl-carousel text-center">
				<div class="item w3-agile">
					<div class="agilegrid agilegrid1">
						<img src="../../img/viewing/package-1.jpg" alt="Odyssey">
						<h4>海南三亚双飞5日游</h4>
						<h5>  ¥ 2078</h5>
						<ul>
				...
				<div class="item w3-agile">
					<div class="agilegrid agilegrid2">
						<img src="../../img/viewing/package-2.jpg" alt="Odyssey">
				...
				<div class="item w3-agile">
					<div class="agilegrid agilegrid3">
						<img src="../../img/viewing/package-3.jpg" alt="Odyssey">
				...
				<div class="item w3-agile">
					<div class="agilegrid agilegrid4">
						<img src="../../img/viewing/package-4.jpg" alt="Odyssey">
				...
				<div class="item w3-agile">
					<div class="agilegrid agilegrid5">
						<img src="../../img/viewing/package-5.jpg" alt="Odyssey">
				...
				<div class="item w3-agile">
					<div class="agilegrid agilegrid6">
						<img src="../../img/viewing/package-6.jpg" alt="Odyssey">
						<h4>北京国泰酒店双飞5日自由行</h4>
						<h5>  ¥ 2494</h5>
						<ul>
							<li>北京国泰饭店连住4晚</li>
	...
	<div class="w3portfolioaits" id="w3portfolioaits">
		...
		<div class="w3portfolioaits-items">
			<div class="col-md-3 w3portfolioaits-item w3portfolioaits-item-1">
				<a class="example-image-link" href="../../img/viewing/portfolio-1.jpg" data-lightbox="example-set" data-title="">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="../../img/viewing/portfolio-1.jpg" alt="Game Robo" style="height: 300px;">
			...
			<div class="col-md-3 w3portfolioaits-item w3portfolioaits-item-2">
				<a class="example-image-link" href="../../img/viewing/portfolio-2.jpg" data-lightbox="example-set" data-title="">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="../../img/viewing/portfolio-2.jpg" alt="Game Robo" style="height: 300px;">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			...
			<div class="col-md-3 w3portfolioaits-item w3portfolioaits-item-3">
				<a class="example-image-link" href="../../img/viewing/portfolio-3.jpg" data-lightbox="example-set" data-title="">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="../../img/viewing/portfolio-3.jpg" alt="Game Robo" style="height: 300px;">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			...
			<div class="col-md-3 w3portfolioaits-item w3portfolioaits-item-4">
				<a class="example-image-link" href="../../img/viewing/portfolio-4.jpg" data-lightbox="example-set" data-title="">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="../../img/viewing/portfolio-4.jpg" alt="Game Robo" style="height: 300px;">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			...
			<div class="col-md-3 w3portfolioaits-item w3portfolioaits-item-5">
				<a class="example-image-link" href="../../img/viewing/portfolio-5.jpg" data-lightbox="example-set" data-title="">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="../../img/viewing/portfolio-5.jpg" alt="Game Robo" style="height: 300px;">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			...
			<div class="col-md-3 w3portfolioaits-item w3portfolioaits-item-6">
				<a class="example-image-link" href="../../img/viewing/portfolio-6.jpg" data-lightbox="example-set" data-title="">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="../../img/viewing/portfolio-6.jpg" alt="Game Robo" style="height: 300px;">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			...
			<div class="col-md-3 w3portfolioaits-item w3portfolioaits-item-7">
				<a class="example-image-link" href="../../img/viewing/portfolio-7.jpg" data-lightbox="example-set" data-title="">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="../../img/viewing/portfolio-7.jpg" alt="Game Robo" style="height: 300px;">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			...
			<div class="col-md-3 w3portfolioaits-item w3portfolioaits-item-8">
				<a class="example-image-link" href="../../img/viewing/portfolio-8.jpg" data-lightbox="example-set" data-title="">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="../../img/viewing/portfolio-8.jpg" alt="Game Robo" style="height: 300px;">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			...
			<div class="col-md-3 w3portfolioaits-item w3portfolioaits-item-9">
				<a class="example-image-link" href="../../img/viewing/portfolio-9.jpg" data-lightbox="example-set" data-title="">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="../../img/viewing/portfolio-9.jpg" alt="Game Robo" style="height: 300px;">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			...
			<div class="col-md-3 w3portfolioaits-item w3portfolioaits-item-9">
				<a class="example-image-link" href="../../img/viewing/portfolio-10.jpg" data-lightbox="example-set" data-title="">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="../../img/viewing/portfolio-10.jpg" alt="Game Robo" style="height: 300px;">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			...
			<div class="col-md-3 w3portfolioaits-item w3portfolioaits-item-9">
				<a class="example-image-link" href="../../img/viewing/portfolio-11.jpg" data-lightbox="example-set" data-title="">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="../../img/viewing/portfolio-11.jpg" alt="Game Robo" style="height: 300px;">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
			...
			<div class="col-md-3 w3portfolioaits-item w3portfolioaits-item-9">
				<a class="example-image-link" href="../../img/viewing/portfolio-12.jpg" data-lightbox="example-set" data-title="">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="../../img/viewing/portfolio-12.jpg" alt="Game Robo" style="height: 300px;">
								<figcaption></figcaption>
						</figure>
					</div>
				</a>
	...
	<div class="wthreereviews" id="wthreereviews">
		<main>
			<div class="cd-image-block">
				<ul class="cd-img-list">
					<li class="is-selected agiletravelerw3ls agiletravelerw3ls1">
						<a href="#0">
							<h3>所有的游记都不如亲身经历</h3>
							<img src="../../img/viewing/opinion-1.jpg" alt="Odyssey">
							<h4>夏虫语冰</h4>
					...
					<li class="agiletravelerw3ls agiletravelerw3ls2">
						<a href="#0">
							...
							<img src="../../img/viewing/opinion-2.jpg" alt="Odyssey">
							<h4>柳叶飘飘</h4>
							<p>一座山城，一座夜城。
								不一样的风景，一样的执着。
					...
					<li class="agiletravelerw3ls agiletravelerw3ls3">
						<a href="#0">
							<h3>秋韵坎布拉 无墨自成画</h3>
							<img src="../../img/viewing/opinion-3.jpg" alt="Odyssey">
							<h4>胡不破</h4>
	...
	<!-- Default-JavaScript -->   <script type="text/javascript" src="../../js/viewing/jquery-2.1.4.min.js"></script>
	<!-- Bootstrap-JavaScript --> <script type="text/javascript" src="../../js/viewing/bootstrap.js"></script>

<!-- Responsive-Slider-JavaScript -->
			<script src="../../js/viewing/responsiveslides.min.js"></script>
			<script>
				$(function () {
		...
		<!-- Review-Slider-JavaScript -->
			<script src="../../js/viewing/main.js"></script>
		<!-- //Review-Slider-JavaScript -->

		<!-- Tour-Locations-JavaScript -->
			<script src="../../js/viewing/classie.js"></script>
			<script src="../../js/viewing/helper.js"></script>
			<script src="../../js/viewing/grid3d.js"></script>
			<script>
		...
		<!-- Owl-Carousel-JavaScript -->
			<script src="../../js/viewing/owl.carousel.js"></script>
			<script>
		...
		<!-- Pricing-Popup-Box-JavaScript -->
			<script src="../../js/viewing/jquery.magnific-popup.js" type="text/javascript"></script>
			<script>
				$(document).ready(function() {
		...
		<!-- Date-Picker-JavaScript -->
			<script src="../../js/viewing/jquery-ui.js"></script>
			<script>
				$(function() {
		...
		<!-- Portfolio-Popup-Box-JavaScript -->
			<script src="../../js/viewing/jquery.chocolat.js"></script>
